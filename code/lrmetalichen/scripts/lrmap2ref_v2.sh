...
minimap2 -ax map-hifi ${ref} ${reads} | samtools view  -T ${ref} -F 256 -uS  | samtools sort  -@ ${threads_sam} -o ${outprefix}_${refix}_raw.bam
samtools index -@ ${threads_sam} ${outprefix}_${refix}_raw.bam
lrmetalichen/scripts/bam_ani-filter.py ${outprefix}_${refix}_raw.bam 90 60 | samtools view  -@ ${threads_sam} -u -o ${outprefix}_${refix}_sorted.bam
...
samtools idxstats  -@ ${threads_sam} ${outprefix}_${refix}_sorted.bam > ${outprefix}_${refix}_depth.tab
...
samtools view   -@ ${threads_sam} -q 1 -u ${outprefix}_${refix}_sorted.bam -o ${outprefix}_${refix}_unique_sorted.bam
